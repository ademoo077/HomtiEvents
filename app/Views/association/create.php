<?php
/** @var array $communes @var array $anomalies @var array $epics @var array $errors @var array $old */
        ...
        <div class="card-body">
            <form method="post" action="<?= url('association') ?>">
                ...
                <div class="mb-3">
                    ...
                    <?php if (isset($errors['commune_id'])): ?><div class="text-danger small"><?= e($errors['commune_id']) ?></div><?php endif; ?>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <?php if (isset($errors['adresse'])): ?><div class="text-danger small"><?= e($errors['adresse']) ?></div><?php endif; ?>
                </div>
