...
<div class="futur-control">
    <div class="futur-control-header">
        <div>
            <h2 class="futur-control-title"><i class="mdi mdi-view-dashboard"></i> <?= e(__('common.dashboard')) ?></h2>
            <p class="futur-control-sub"><?= $isAr ? 'مركز المراقبة — إدارة شاملة للمنصة' : 'Control Center — Supervision et gestion centralisée de la plateforme' ?></p>
        </div>
    </div>
