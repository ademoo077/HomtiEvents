    ...
    <div class="wh-hero-inner">
        <div class="wh-hero-row">
            <div class="wh-hero-text">
                <h1 class="wh-hero-title"><i class="mdi mdi-account-group me-2"></i><?= $isAr ? 'الجمعيات' : 'Associations' ?></h1>
                <p class="wh-hero-sub"><?= $isAr ? 'إدارة وتوثيق جمعيات الولاية' : 'Gestion et validation des associations' ?></p>
            </div>
            <div class="wh-hero-actions">
                <a class="btn btn-light" href="<?= url('control/associations/create') ?>">
