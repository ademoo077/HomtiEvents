    ...
    <div class="wh-hero-inner">
        <div class="wh-hero-row">
            <div class="wh-hero-text">
                <h1 class="wh-hero-title"><i class="mdi mdi-city me-2"></i><?= $isAr ? 'البلديات' : 'Communes' ?></h1>
                <p class="wh-hero-sub"><?= $isAr ? 'إدارة بلديات ودوائر الولاية' : 'Gestion des communes et daïras' ?></p>
            </div>
            <div class="wh-hero-actions">
                <a class="btn btn-light" href="<?= url('control/communes/create') ?>">
