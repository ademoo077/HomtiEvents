...
<div class="futur-control">
    <div class="futur-control-header">
        <div>
            <h2 class="futur-control-title"><i class="mdi mdi-scale-balance"></i> <?= e(__('common.rules')) ?></h2>
            <p class="futur-control-sub"><?= $isAr ? 'محرك قواعد الأعمال — قيود وتفعيلات ديناميكية' : 'Moteur de règles métier — règles dynamiques et contrôles' ?></p>
        </div>
        <a class="futur-btn futur-btn-sm futur-btn-outline" href="<?= e(url('control/regles')) ?>" data-bs-toggle="modal" data-bs-target="#regleModal">
